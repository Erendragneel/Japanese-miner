const CACHE='japanese-miner-v5.7';
const ASSETS=['./','./index.html','./styles.css?v=5.7','./v5.css?v=5.7','./game.js?v=5.7','./v5.js?v=5.7','./manifest.webmanifest','./assets/favicon.svg'];
