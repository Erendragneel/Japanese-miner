const CACHE='japanese-miner-v5.2';
const ASSETS=['./','./index.html','./styles.css?v=5.2','./v5.css?v=5.2','./game.js?v=5.2','./v5.js?v=5.2','./manifest.webmanifest','./assets/favicon.svg'];
