const CACHE='japanese-miner-v5.3.1';
const ASSETS=['./','./index.html','./styles.css?v=5.3.1','./v5.css?v=5.3.1','./game.js?v=5.3.1','./v5.js?v=5.3.1','./manifest.webmanifest','./assets/favicon.svg'];
