const CACHE='japanese-miner-v5.8';
const ASSETS=['./','./index.html','./styles.css?v=5.8','./v5.css?v=5.8','./game.js?v=5.8','./v5.js?v=5.8','./manifest.webmanifest','./assets/favicon.svg'];
