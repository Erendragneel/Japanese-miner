const CACHE='japanese-miner-v6.1.2';
const ASSETS=['./','./index.html','./styles.css?v=6.1.2','./v5.css?v=6.1.2','./v6.css?v=6.1.2','./game.js?v=6.1.2','./v5.js?v=6.1.2','./v6.js?v=6.1.2','./manifest.webmanifest','./assets/favicon.svg','./assets/avatar/anime-miner-v1.png'];
