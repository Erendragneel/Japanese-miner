const CACHE='japanese-miner-v5.6';
const ASSETS=['./','./index.html','./styles.css?v=5.6','./v5.css?v=5.6','./game.js?v=5.6','./v5.js?v=5.6','./manifest.webmanifest','./assets/favicon.svg'];
