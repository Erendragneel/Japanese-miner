const CACHE='japanese-miner-v6.0.8';
const ASSETS=['./','./index.html','./styles.css?v=6.0.8','./v5.css?v=6.0.8','./v6.css?v=6.0.8','./game.js?v=6.0.8','./v5.js?v=6.0.8','./v6.js?v=6.0.8','./manifest.webmanifest','./assets/favicon.svg'];
