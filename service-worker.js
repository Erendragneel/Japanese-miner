const CACHE='japanese-miner-v6.1.0';
const ASSETS=['./','./index.html','./styles.css?v=6.1.0','./v5.css?v=6.1.0','./v6.css?v=6.1.0','./game.js?v=6.1.0','./v5.js?v=6.1.0','./v6.js?v=6.1.0','./manifest.webmanifest','./assets/favicon.svg'];
