const CACHE='japanese-miner-v5.0';
const ASSETS=['./','./index.html','./styles.css?v=5.0','./v5.css?v=5.0','./game.js?v=5.0','./v5.js?v=5.0','./manifest.webmanifest','./assets/favicon.svg'];
