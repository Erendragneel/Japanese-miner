const CACHE='japanese-miner-v5.4';
const ASSETS=['./','./index.html','./styles.css?v=5.4','./v5.css?v=5.4','./game.js?v=5.4','./v5.js?v=5.4','./manifest.webmanifest','./assets/favicon.svg'];
