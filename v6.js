...
(()=>{
'use strict';
const VERSION='6.4.91-language-miner', SNAPSHOT_PREFIX='jm_v6_snapshots_', FEEDBACK_INBOX_KEY='jm_v6_admin_feedback_inbox', FEEDBACK_INBOX_LIMIT=200;
...
function ensureV6(){
 state.v6=Object.assign({tourComplete:false,onboardingGuideOffered:false,textSize:'normal',reducedMotion:false,highContrast:false,colorAssist:false,showFloatingCompanion:true,sfxVolume:70,musicVolume:35,explanations:true,feedback:[],storySeen:[],lastSnapshot:0,supporterTier:0},state.v6||{});
...
function supporterTier(){ensureV6();return isDeveloperSession===true?3:verifiedSupporterTier;}
