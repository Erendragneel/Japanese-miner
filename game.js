...
(function(){
  ...
  function renderedColorVars(c,style,fashion={}){const art=(category,value)=>`url("${window.getJapaneseMinerRecolor(`${style}/${category}/${value}`)}")`,jacket=fashion.jacket||'none',gloves=fashion.gloves||'none',shoes=fashion.shoes||'boots',garment=jacket!=='none'?art('jacket',jacket):art('shirt',c.shirt);return `--recolor-skin:${art('skin',c.skin)};--recolor-hair:${art('hair',c.hairColor)};--recolor-shirt:${garment};--recolor-pants:${art('pants',c.pants)};--recolor-gloves:${gloves==='none'?'none':art('gloves',gloves)};--recolor-shoes:${art('shoes',shoes)}`;}
  ...
  function characterMarkup(size='large',override={}){
    ...
    const maskStyle=hairstyleImages[c.hairStyle]?c.hairStyle:'spiky',maskRoot=`assets/avatar/hairstyles/masks/${maskStyle}`;
    const fashion=Object.assign({jacket:'none',gloves:'none',shoes:'boots'},state.v5?.fashion||{}),maskVars=`--mask-skin:url(${maskRoot}/skin.png);${renderedColorVars(c,maskStyle,fashion)}`;
    return `<div class="miner-avatar ${size}" style="${maskVars}" data-skin="${c.skin}" data-hair-style="${c.hairStyle}" data-hair-color="${c.hairColor}" data-shirt="${c.shirt}" data-pants="${c.pants}" data-accessory="${c.accessory}" data-jacket="${fashion.jacket}" data-gloves="${fashion.gloves}" data-shoes="${fashion.shoes}" aria-label="Customized miner character">
      <img class="avatar-render" src="${avatarImage}" alt="" draggable="false"><div class="rendered-avatar-layers" aria-hidden="true"><i class="rendered-skin-tint"></i><i class="rendered-hair-tint"></i><i class="rendered-shirt-tint"></i><i class="rendered-pants-tint"></i><i class="rendered-glove-tint"></i><i class="rendered-shoe-tint"></i><i class="rendered-accessory"></i></div><div class="avatar-shadow"></div><div class="avatar-legs"><i></i><i></i></div><div class="avatar-body"><div class="avatar-shirt-detail"></div><div class="avatar-collar"></div><div class="avatar-utility-belt"><i></i><i></i></div><div class="avatar-pendant"></div><div class="avatar-arm left"></div><div class="avatar-arm right"></div></div><div class="avatar-neck"></div><div class="avatar-head"><div class="avatar-ear left"></div><div class="avatar-ear right"></div><div class="avatar-hair back"></div><div class="avatar-face"><i class="brow left"></i><i class="brow right"></i><i class="eye left"></i><i class="eye right"></i><i class="mouth"></i></div><div class="avatar-hair front"></div><div class="avatar-hair-streak"></div><div class="avatar-accessory"></div></div></div>`;
  }
