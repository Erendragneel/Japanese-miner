...
(function(){
  ...
  function characterMarkup(size='large',override={}){
    ...
    return `<div class="miner-avatar ${size}" data-skin="${c.skin}" data-hair-style="${c.hairStyle}" data-hair-color="${c.hairColor}" data-shirt="${c.shirt}" data-pants="${c.pants}" data-accessory="${c.accessory}" aria-label="Customized miner character">
      <img class="avatar-render" src="assets/avatar/anime-miner-v1.png" alt="" draggable="false"><div class="rendered-avatar-layers" aria-hidden="true"><i class="rendered-hair-tint"></i><i class="rendered-shirt-tint"></i><i class="rendered-pants-tint"></i><i class="rendered-glove-tint"></i><i class="rendered-shoe-tint"></i><i class="rendered-accessory"></i></div><div class="avatar-shadow"></div><div class="avatar-legs"><i></i><i></i></div><div class="avatar-body"><div class="avatar-shirt-detail"></div><div class="avatar-collar"></div><div class="avatar-utility-belt"><i></i><i></i></div><div class="avatar-pendant"></div><div class="avatar-arm left"></div><div class="avatar-arm right"></div></div><div class="avatar-neck"></div><div class="avatar-head"><div class="avatar-ear left"></div><div class="avatar-ear right"></div><div class="avatar-hair back"></div><div class="avatar-face"><i class="brow left"></i><i class="brow right"></i><i class="eye left"></i><i class="eye right"></i><i class="mouth"></i></div><div class="avatar-hair front"></div><div class="avatar-hair-streak"></div><div class="avatar-accessory"></div></div></div>`;
  }
