...
(function(){
  ...
  function characterMarkup(size='large',override={}){
    ...
    const maskVars=`--mask-skin:url(${maskRoot}/skin.png);--mask-hair:url(${maskRoot}/hair.png);--mask-jacket:url(${maskRoot}/jacket.png);--mask-pants:url(${maskRoot}/pants.png);--mask-gloves:url(${maskRoot}/gloves.png);--mask-shoes:url(${maskRoot}/shoes.png)`;
    return `<div class="miner-avatar ${size}" style="${maskVars}" data-skin="${c.skin}" data-hair-style="${c.hairStyle}" data-hair-color="${c.hairColor}" data-shirt="${c.shirt}" data-pants="${c.pants}" data-accessory="${c.accessory}" aria-label="Customized miner character">
